...
registerMooseAction( "tardigradeApp", MicromorphicContinuumAction, "add_kernel" );

registerMooseAction( "tardigradeApp", MicromorphicContinuumAction, "add_material" );

const std::vector< std::string > MicromorphicContinuumAction::excludedParameters = {
    "model_name",
...
InputParameters
MicromorphicContinuumAction::validParams()
{
  ...
  params.addParam< std::vector< AuxVariableName > >( "save_in_disp_x",
                                                     "Store displacement residuals (aka reaction forces)" );
...
MicromorphicContinuumAction::MicromorphicContinuumAction(
    ...
    _nmicro_disp_grad ( getParam< std::vector< VariableName > >( "micro_displacement_gradient" ).size() )
{
  if ( _ndisp != 3 || _nmicro_disp_grad  != 9 )
    mooseError( "Micromorphic kernels are implemented currently only for 3D!" );
...
void
MicromorphicContinuumAction::addKernels()
{
  ...
  for ( unsigned int i = 0; i < 3 ; ++i )
  {
    ...
    if ( i == 0 && isParamValid( "save_in_disp_x" ) )
      internal_force_kernel_params.set< std::vector< AuxVariableName > >( "save_in" ) =
...
void
MicromorphicContinuumAction::addMaterial()
{
  std::string materialType = "MicromorphicMaterial";
  ...
  materialParameters.set< std::vector< VariableName> >( "u1" ) = {getParam< std::vector< VariableName > >( "displacements" )[0]};
  materialParameters.set< std::vector< VariableName> >( "u2" ) = {getParam< std::vector< VariableName > >( "displacements" )[1]};
  materialParameters.set< std::vector< VariableName> >( "u3" ) = {getParam< std::vector< VariableName > >( "displacements" )[2]};

  materialParameters.set< std::vector< VariableName> >( "phi_11" ) = { getParam< std::vector< VariableName > >( "micro_displacement_gradient" )[0] } ;
  materialParameters.set< std::vector< VariableName> >( "phi_12" ) = { getParam< std::vector< VariableName > >( "micro_displacement_gradient" )[1] } ;
  materialParameters.set< std::vector< VariableName> >( "phi_13" ) = { getParam< std::vector< VariableName > >( "micro_displacement_gradient" )[2] } ;
  materialParameters.set< std::vector< VariableName> >( "phi_21" ) = { getParam< std::vector< VariableName > >( "micro_displacement_gradient" )[3] } ;
  materialParameters.set< std::vector< VariableName> >( "phi_22" ) = { getParam< std::vector< VariableName > >( "micro_displacement_gradient" )[4] } ;
  materialParameters.set< std::vector< VariableName> >( "phi_23" ) = { getParam< std::vector< VariableName > >( "micro_displacement_gradient" )[5] } ;
  materialParameters.set< std::vector< VariableName> >( "phi_31" ) = { getParam< std::vector< VariableName > >( "micro_displacement_gradient" )[6] } ;
  materialParameters.set< std::vector< VariableName> >( "phi_32" ) = { getParam< std::vector< VariableName > >( "micro_displacement_gradient" )[7] } ;
  materialParameters.set< std::vector< VariableName> >( "phi_33" ) = { getParam< std::vector< VariableName > >( "micro_displacement_gradient" )[8] } ;
